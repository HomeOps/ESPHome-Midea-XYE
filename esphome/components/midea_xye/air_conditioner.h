...
// 0xC6 Command subcommand types (TXData[10])
#define C6_SUBCOMMAND_FOLLOW_ME_UPDATE 0x02
#define C6_SUBCOMMAND_STATIC_PRESSURE 0x04
#define C6_SUBCOMMAND_FOLLOW_ME_INIT 0x06
